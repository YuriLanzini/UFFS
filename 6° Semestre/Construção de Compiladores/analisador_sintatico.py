class SyntaxAnalyzer:
    ...
    def __init__(self, file_path):
        ...
        self.input_tokens, self.tabela_simbolos = self.ler_tokens_do_arquivo(file_path)
        ...
        self.parsing_table = {
            ...
            (8, ')'): 'r21', (8, '}'): 'r21', (8, '=='): 'r21', (8, '!='): 'r21', (8, '<'): 'r21', (8, '<='): 'r21', (8, '>'): 'r21', (8, '>='): 'r21', (8, '+'): 'r21', (8, '-'): 'r21', (8, '*'): 's27', (8, '/'): 's28', (8, ';'): 'r21', (8, 'H1'): 'p26',
            ...
            (57, ')'): 'r16', (57, '}'): 'r16', (57, '=='): 'r16', (57, '!='): 'r16', (57, '<'): 'r16', (57, '<='): 'r16', (57, '>'): 'r16', (57, '>='): 'r16', (57, ';'): 'r15',
    ...
    def ler_tokens_do_arquivo(self, nome_arquivo):
        tokens = []
        dados_saida = []  
...
# Função para simular o parsing usando a tabela e a pilha
    def parse(self):
        ...
        while True:
            ...
            token = self.input_tokens[index]  # Símbolo atual ou fim de entrada
            ...
            if token in valid_operators:
                op1 = token = self.input_tokens[index-1]
                op2 = token = self.input_tokens[index+1]
                if op1 != op2:
                    print(f"Erro semântico: linha {line}")
                    return
                token = self.input_tokens[index]

            # Verifica ação da tabela de parsing
            action = self.parsing_table.get((state, token))
            ...
            if action is None:
                if token == 'ERROR':
                    ...
                    print(f"Erro de sintaxe: token: {token}, state: {state}, action: {action} linha {line}")
                    return
            ...
            if action == 'acc':  # Aceitação
                ...
                head, body = self.productions[prod_num]
                ...
                goto_state = self.parsing_table.get((top_state, head))
