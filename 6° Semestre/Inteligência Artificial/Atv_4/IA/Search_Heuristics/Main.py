...
from Search_Heuristics.Local.Neighbourhood.VizinhancaSwap import VizinhancaSwap
...
def main():
    for idx, arquivo in enumerate(arquivos):
        ...
        algoritmos = (
            ...
            BuscaLocalPrimeiraMelhora(VizinhancaSwap(distancias), solucao_otima),  # Mudar nome para a Vizinhanca implementada
